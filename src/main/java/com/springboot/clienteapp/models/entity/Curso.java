...
public class Curso extends NotaPedido implements Serializable {
	...
	/*
	 * private Set<Date> getFechas() { return fecha; } private void
	 * setFechas(Set<Date> fechas) { this.fecha = fechas; }
	 * 
	 * @Override public String toString() { return "Curso [cod_curso=" + cod_curso +
	 * ", fecha=" + fecha + "]"; }
	 */

	@Override
	public String toString() {
		return "Curso [cod_curso=" + cod_curso + "]";
	}
